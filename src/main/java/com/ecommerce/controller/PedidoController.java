...
public class PedidoController {
    ...
    public ResponseEntity<Cupom> findCupomById(@PathVariable Integer codigo) {
    ...
    public ResponseEntity<Cupom> updateCupom(@PathVariable Integer codigo, @RequestBody Cupom cupom) {
        return ResponseEntity.ok(pedidoService.updateCupom(codigo, cupom));
    }

    @DeleteMapping("/cupons/{codigo}")
    public ResponseEntity<Void> deleteCupom(@PathVariable Integer codigo) {
