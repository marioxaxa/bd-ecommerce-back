...
class ProdutoRepositoryTest {
    ...
    void deveRetornarProdutosPorCategoria() {
        Produto produto1 = new Produto(1, "Samsung", "Galaxy S23", "Samsung", categoria.id());
        Produto produto2 = new Produto(2, "Apple", "iPhone 15", "Apple", categoria.id());
    ...
    void deveRetornarTodosProdutos() {
        ...
        Produto produto1 = new Produto(1, "Samsung", "Galaxy", "Samsung", categoria.id());
        Produto produto2 = new Produto(2, "Nike", "Camiseta", "Nike", categoria2.id());
    ...
    void deveAtualizarProduto() {
        ...
        Produto produtoAtualizado = new Produto(produto.id(), "Apple", "iPhone", "Apple Inc.", categoria.id());
