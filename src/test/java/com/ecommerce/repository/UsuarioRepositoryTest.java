...
class UsuarioRepositoryTest {
    ...
    @BeforeEach
    void setUp() {
        usuario = new Usuario(123456789, "teste@email.com", "senha123", "testuser", false);
    }
    ...
    void deveRetornarVazioQuandoNaoExistir() {
        Optional<Usuario> result = usuarioRepository.findById(999999999);
    ...
    void deveRetornarTodosUsuarios() {
        Usuario usuario1 = new Usuario(111111111, "user1@email.com", "senha1", "user1", false);
        Usuario usuario2 = new Usuario(222222222, "user2@email.com", "senha2", "user2", true);
    ...
    void deveRetornarZeroAoDeletarInexistente() {
        int rowsAffected = usuarioRepository.delete(999999999);
    ...
    void deveMapearCampoGerente() {
        Usuario gerente = new Usuario(111111111, "gerente@email.com", "senha", "gerente", true);
        Usuario cliente = new Usuario(222222222, "cliente@email.com", "senha", "cliente", false);
        
        usuarioRepository.save(gerente);
        usuarioRepository.save(cliente);

        Optional<Usuario> gerenteResult = usuarioRepository.findById(111111111);
        Optional<Usuario> clienteResult = usuarioRepository.findById(222222222);
