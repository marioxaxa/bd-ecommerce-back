...
public class PedidoService {
    ...
    public List<Pedido> findByUsuarioCpf(Long usuarioCpf) {
        return pedidoRepository.findByUsuarioCpf(usuarioCpf);
    }
    ...
    private void validarCupom(String cupomCodigo) {
    ...
    public Optional<Cupom> findCupomById(String codigo) {
    ...
    public Cupom updateCupom(String codigo, Cupom cupom) {
    ...
    public void deleteCupom(String codigo) {
        cupomRepository.findById(codigo)
            .orElseThrow(() -> new RuntimeException("Cupom não encontrado com código: " + codigo));
