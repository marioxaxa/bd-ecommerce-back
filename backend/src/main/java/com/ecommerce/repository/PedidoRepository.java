...
public class PedidoRepository {
    ...
    private static final String SELECT_BY_USUARIO = "SELECT p.codigo, p.cupom_codigo, p.carrinho_id, p.pagamento_id, p.entrega_id FROM pedido p INNER JOIN carrinho c ON c.id = p.carrinho_id WHERE c.usuario_cpf = ?";
    ...
    public List<Pedido> findByUsuarioCpf(Long usuarioCpf) {
        return jdbcTemplate.query(SELECT_BY_USUARIO, new PedidoRowMapper(), usuarioCpf);
    }
